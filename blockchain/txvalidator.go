...
import (
	...
	"github.com/ioeX/ioeX.SideChain/common"
...
func CheckRechargeToSideChainTransaction(txn *core.Transaction) error {
	...
	payloadObj, ok := mainChainTransaction.Payload.(*ioex.PayloadTransferCrossChainAsset)
	if !ok {
		return errors.New("Invalid payload ioex.PayloadTransferCrossChainAsset")
	}
