...
import (
	...
	"github.com/ioeX/ioeX.SideChain/auxpow"
...
func GetGenesisBlock() (*core.Block, error) {
	...
	header := core.Header{
		...
		Bits:       0x1d03ffff,
		Nonce:      core.GenesisNonce + config.Parameters.Magic,
		Height:     uint32(0),
		SideAuxPow: auxpow.SideAuxPow{
			SideAuxBlockTx: ioex.Transaction{
				TxType:         ioex.SideChainPow,
				PayloadVersion: ioex.SideChainPowPayloadVersion,
				Payload:        new(ioex.PayloadSideChainPow),
			},
		},
	}
	...
	block := &core.Block{
		Header:       header,
		Transactions: []*core.Transaction{&ioeXCoin},
	}
